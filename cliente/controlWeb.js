function ControlWeb() {
    ...
    this.mostrarHome = function () {
        ...
        cadena = cadena + '<div class="col" ><h2 style="color:blue" class="titulo">¡Bienvenido! Diviertete en Batalla Naval</h2></div>';
        cadena = cadena + "<div><h3> Usuario " + rest.nick + "     "+"</h3></div>"
        cadena = cadena + '<div style="margin-bottom:20px" id="codigo"></div> '
        cadena = cadena + '<button style="margin:20px" id="btnS" class="row btn btn-primary mb-2 mr-sm-2">Salir</button>';
        cadena = cadena + '</div>'
